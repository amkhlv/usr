...
Are described [here](http://www.electronicwings.com/sensors-modules/dht11) :

![Pinout](DHT11_Pins.png)

DHT library
===========

I use  the Arduino library for reading the DHT family of temperature and humidity sensors
