...
(add-hook 'scribble-mode-hook '(lambda () (local-set-key (kbd "C-c C-c") 'myscribble/compile)))
(add-hook 'scribble-mode-hook '(lambda () (local-set-key (kbd "C-c C-s") 'myscribble/compile-htmls)))
(add-hook 'scribble-mode-hook '(lambda () (local-set-key (kbd "C-c C-v") 'myscribble/view)))
...
;;In dotted pair notation, the list ‘(1 2 3)’ is written as ‘(1 . (2 . (3 . nil)))’
